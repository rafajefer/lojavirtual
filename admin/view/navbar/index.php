...
<div data-page="navbar">
   <h1>Lista de navbar</h1>
   <div class="base-lista">
      <div class="cx-lista">
         <form method="GET" action="index.php" id="form-search">
            <input type="hidden" name="p" value="navbar" />
            <table border="0">
               <tbody>
                  <tr>
      ...
      <h2>Itens do Navbar principal</h2>
      <a href="#" id="register-add">Novo item </a>
      <p class="limpar">&nbsp;</p>
      ...
      <table width="100%" border="0" cellpadding="2" cellspacing="2">
         <thead>
            <tr>
               ...
               <td align="center" class="tdbc">Item</td>
         ...
         <tbody id="listagem">
            <?php
            $striped = 'coluna1';
            foreach ($listagem as $chave => $row):
               ?>
               <tr class="<?php echo $striped; ?>">
                  <td align="center"><?php echo ++$chave; ?></td>
